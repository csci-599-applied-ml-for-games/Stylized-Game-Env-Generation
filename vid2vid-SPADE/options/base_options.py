...
class BaseOptions():
    ...
    def initialize(self):                
        ...
        self.parser.add_argument('--norm_E', type=str, default='spectralinstance', help='instance normalization or batch normalization')
    ...
    def parse(self, save=True):
        ...
        # adding SPADE norm_G to opt
        self.parser.set_defaults(norm_G='spectralspadesyncbatch3x3')
